...
/**
 * Fixed tutorial customer config
 */
export const TUTORIAL_CUSTOMER = {
  id: 'tutorial_customer',
  name: 'Lin Che',
  avatar: '🧥',
  personality: ['quiet', 'tired', 'guarded'],
  dialogueStyle: {
    tone: 'tired',
    length: 'short',
    features: ['few words', 'frequent pauses', 'occasional sighs']
  },
  emotionMask: {
    surface: ['trust'],
  ...
  backstory: 'He was the first person to push open this door. Later, you learned he only got here by taking a wrong turn—but that night, he needed a drink.',
